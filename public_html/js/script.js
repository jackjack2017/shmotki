...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sendform = __webpack_require__(107);
	
	var _mfpopup = __webpack_require__(120);
	
	var _ajaxPopup = __webpack_require__(122);
	
	var _magicPopup = __webpack_require__(123);
	
	var _filter = __webpack_require__(124);
	
	var _google_map = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AjaxPopup = exports.AjaxPopup = function (_Popup) {
	    (0, _inherits3.default)(AjaxPopup, _Popup);
	
	    function AjaxPopup() {
	        (0, _classCallCheck3.default)(this, AjaxPopup);
	        return (0, _possibleConstructorReturn3.default)(this, (AjaxPopup.__proto__ || (0, _getPrototypeOf2.default)(AjaxPopup)).apply(this, arguments));
	    }
	
	    (0, _createClass3.default)(AjaxPopup, [{
	        key: 'openPopup',
	        value: function openPopup() {
	            $.magnificPopup.open({
	                items: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MagicPopup = exports.MagicPopup = function (_Popup) {
	    (0, _inherits3.default)(MagicPopup, _Popup);
	    ...
	    function MagicPopup(openClass, closeClass) {
	        ...
	        (0, _classCallCheck3.default)(this, MagicPopup);
	
	        var _this = (0, _possibleConstructorReturn3.default)(this, (MagicPopup.__proto__ || (0, _getPrototypeOf2.default)(MagicPopup)).call(this, openClass, closeClass));
	
	        data = (0, _assign2.default)(defaultSettings, data);
	        //popup class
	        _this.popupClass = data.popupClass;
	        //bg class
	        _this.bgId = data.bgId;
	        // Node for popup
	        _this.popup = $('<div class="' + _this.popupClass + '"></div>');
	        //Node for background
	        _this.bg = $('<div id="' + _this.bgId + '"></div>');
	        _this.initMagicPopup();
	        return _this;
	    }
	
	    (0, _createClass3.default)(MagicPopup, [{
	        key: 'initMagicPopup',
	        value: function initMagicPopup() {
	            var _this2 = this;
	
	            // Close on bg
	            $('body').on('click', '#' + this.bgId, function (e) {
	                _this2.closePopup();
	            })
	            // Close on modal which does not exist modal window
	            .on('click', '.' + this.popupClass, function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getToken = __webpack_require__(125);
	...
	var Filter = exports.Filter = function () {
	    ...
	    (0, _createClass3.default)(Filter, [{
	        ...
	        value: function changeFilterState(val, attrName) {
	            ...
	            if ((typeof stateAttr === 'undefined' ? 'undefined' : (0, _typeof3.default)(stateAttr)) !== 'object') {
	                stateAttr = val;
	                return;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleMap = exports.GoogleMap = function (_Map) {
	    (0, _inherits3.default)(GoogleMap, _Map);
	    ...
	    function GoogleMap(data) {
	        ...
	        return (0, _possibleConstructorReturn3.default)(this, (GoogleMap.__proto__ || (0, _getPrototypeOf2.default)(GoogleMap)).call(this, data, 'google'));
	    }
	    ...
	    (0, _createClass3.default)(GoogleMap, [{
	        ...
	        value: function initMap() {
	            ...
	            //set map and center
	            var map = new this.map.maps.Map(this.element[0], {
	            ...
	            this.placemarks.forEach(function (placemark) {
	                var geo = new _this2.map.maps.Marker({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get_map = __webpack_require__(128);
	
	var _get_map2 = _interopRequireDefault(_get_map);
	...
	var Map = exports.Map = function (_Component) {
	    ...
	    function Map(data, map) {
	        ...
	        var _this = (0, _possibleConstructorReturn3.default)(this, (Map.__proto__ || (0, _getPrototypeOf2.default)(Map)).call(this, data.identifier));
	
	        if (data.dataFromView) {
	            try {
	                data = _this.getAttrFromView();
	            } catch (err) {
	                console.warn(err);
	        ...
	        //merge objects
	        data = (0, _assign2.default)(defaultConfig, data);
	    ...
	    (0, _createClass3.default)(Map, [{
	        ...
	        value: function loadMap(data) {
	            ...
	            (0, _get_map2.default)(this.maps[this.needleMap]).then(function () {
	                _this2.setAttr(data);
	                _this2.map = global[_this2.needleMap];
	                _this2.initMap();
	            }, function (reason) {
	                _this2.errorInit(reason);
	            });
	        }
	        ...
	        key: 'getAttrFromView',
	        value: function getAttrFromView() {
	            var jsonData = $('#map_json').html();
	        ...
	        key: 'errorInit',
	        value: function errorInit(reason) {

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                <div>
                    <a href="{{url('dashboard/ecommerce/option/create?g=' . $option_group['id'])}}" class="btn btn-sm btn-info pull-right products-btn" title="Создать новую"><i class="fa  fa-plus"> </i> Добавить</a>
                </div>
                <div class="box-body">

...
@section('title')
    Товары <span class="badge bg-gray pull-right"><span
                ...
                class="badge bg-gray-light">всего {{$products_data['total']}}</span> <span class="badge bg-green">активных {{$products_data['active']}}</span> <span
                class="badge bg-black">архивных {{$products_data['un_active']}}</span></span>
@endsection
                            ...
                            <div class="col-sm-12">
                                <table class="@if(!config('webmagic.dashboard.ecommerce.pagination_use')) js_data_table @endif table table-bordered table-hover dataTable"
                                    ...
                                    <tr role="row">
                                        ...
                                        @if(config('webmagic.ecommerce.category_use'))
